...
/**
 * isConnectingYourServer certificate
 * 
 * @author wanglin
 */
public class EasySSLSocketFactory implements LayeredSocketFactory {
     ...
     * conn/ssl/SSLSocketFactory.html
     */
    private static SSLContext createEasySSLContext() throws IOException {
        try {
            ...
            // Server.
            InputStream clientStream = BaseApplication.getContext()
                                                        .getResources()
            ...
            instream = BaseApplication.getContext()
                                        .getResources()
    ...
    private static SSLContext createIgnoreSSLContext() throws IOException {
        try {
            SSLContext context = SSLContext.getInstance("TLS");
            context.init(null,
                         new TrustManager[] { new IgnoreCertTrustManager() },
                         null);
            return context;
        }
        catch (Exception e) {
    ...
    public boolean equals(Object obj) {
        return ((obj != null) && obj.getClass()
                                    .equals(EasySSLSocketFactory.class));
    }
