package org.kteam.common.network.volleyext.image;
 ...
 * associated request.
 */
public class AnimateNetworkImageView extends AnimateImageView {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (attrs == null) {
			...
			TypedArray attributes = context.obtainStyledAttributes(attrs,
					R.styleable.AnimateNetworkImageView);
			...
			if (attributes == null) {
				...
				mDefaultImageId = attributes.getResourceId(
						R.styleable.AnimateNetworkImageView_default_image, 0);
				mErrorImageId = attributes.getResourceId(
						R.styleable.AnimateNetworkImageView_error_image, 0);
				attributes.recycle();
	 ...
	 * {@link com.common.volleyext.image.AnimateNetworkImageView#setDefaultImageResId(int)} on the view.
	 * NOTE: If applicable,
	 * {@link com.common.volleyext.image.AnimateNetworkImageView#setDefaultImageResId(int)} and
	 * {@link com.common.volleyext.image.AnimateNetworkImageView#setErrorImageResId(int)} should be called
