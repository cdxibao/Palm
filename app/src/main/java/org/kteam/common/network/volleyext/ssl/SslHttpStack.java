...
import org.kteam.common.network.volleyext.request.MultiPartRequest;
...
/**
 * base HttpClient-4.2.5 jar ext http stack
 * 
 * @author wanglin
 */
public class SslHttpStack implements HttpStack {
    ...
    public HttpResponse performRequest(Request<?> request,
        ...
        registry.register(new Scheme("https",
                                     new EasySSLSocketFactory(mIsConnectingToYourServer),
                                     443));
