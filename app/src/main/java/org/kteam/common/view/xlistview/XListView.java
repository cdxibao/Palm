...
/**
 * @Description 可下拉ListView
 * @Author Micky Liu
 * @Email mickyliu@126.com
 * @Date 2015-06-15 17:44
 */
public class XListView extends ListView implements OnScrollListener {
    ...
    public void updateRefreshTime() {
        String time = mSharedPreferenceUtils.getRefereshTime(XSharedPreferenceUtils.TYPE_LIST_VIEW, mKey);
        time = DateUtils.getTodayOrYestodayStr(time);
        mHeaderTimeView.setText(time);
    }

    public void saveRefreshTime() {
        mSharedPreferenceUtils.setRefreshTime(XSharedPreferenceUtils.TYPE_LIST_VIEW, mKey);
    }
    ...
    public void autoRefresh() {
        ...
        if (mEnablePullRefresh && !mPullRefreshing) {
            ...
            int d = mHeaderView.getVisiableHeight();
            if (mHeaderView.getVisiableHeight() > mHeaderViewHeight) {
                mHeaderView.setState(XListViewHeader.STATE_READY);
            } else {
                mHeaderView.setState(XListViewHeader.STATE_NORMAL);
