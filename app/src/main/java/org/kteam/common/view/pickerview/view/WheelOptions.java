package org.kteam.common.view.pickerview.view;
...
import org.kteam.common.view.pickerview.adapter.ArrayWheelAdapter;
import org.kteam.common.view.pickerview.lib.WheelView;
import org.kteam.common.view.pickerview.listener.OnItemSelectedListener;
...
//		// 添加联动监听
	...
	public void setGravity(int gravity) {
		...
		if (wv_option2 != null) {
			wv_option2.setGravity(gravity);
		}
		if (wv_option3 != null) {
			wv_option3.setGravity(gravity);
		}
	}
...
/**
	...
	public ArrayList<T> getmOptions1Items() {
		return mOptions1Items;
	}

	public ArrayList<T> getmOptions2Items(int index) {
		return mOptions2Items.get(index);
	}
}
