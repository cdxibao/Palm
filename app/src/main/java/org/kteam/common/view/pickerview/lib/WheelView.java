package org.kteam.common.view.pickerview.lib;
...
import org.kteam.common.view.pickerview.adapter.WheelAdapter;
    ...
    private void measuredCenterContentStart(String content) {
        ...
        switch (mGravity){
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawCenterContentStart = ViewUtils.dip2px(getContext(), 10);
                break;
            case Gravity.RIGHT:
    ...
    private void measuredOutContentStart(String content) {
        ...
        switch (mGravity){
            case Gravity.CENTER:
                ...
                break;
            case Gravity.LEFT:
                drawOutContentStart = ViewUtils.dip2px(getContext(), 10);
                break;
            case Gravity.RIGHT:
