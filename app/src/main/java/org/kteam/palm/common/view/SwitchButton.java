...
public class SwitchButton extends View implements View.OnTouchListener, View.OnClickListener{
    ...
    // 开关监听器
    private List<OnSwitchListener> onSwitchListenerList;
    ...
    private void init(AttributeSet attrs) {
        if(attrs != null && getContext() != null){
            ...
            if(typedArray != null){
                switchOnBkg = ((BitmapDrawable)typedArray.getDrawable(R.styleable.SwitchButton_switchOnBg)).getBitmap();
                switchOffBkg = ((BitmapDrawable)typedArray.getDrawable(R.styleable.SwitchButton_switchOffBg)).getBitmap();
                slipSwitchButton = ((BitmapDrawable)typedArray.getDrawable(R.styleable.SwitchButton_slipBtn)).getBitmap();
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN:
                if (ViewUtils.isFastClick()) break;
                isSlipping = true;
                break;
